    ...
    <div class="user-panel">
        <div class="row" align="center">
            <div class="col-md-12">
                ...
                @if(App\Kyc::where('user_id', Auth::user()->id)->count() == 0)
                    <button class="btn btn-warning btn-sm" style="margin-top: -20%">KYC Pending</button>
                @else
                  @if(App\Kyc::where('user_id', Auth::user()->id)->first()->status == 1)
                      <button class="btn btn-warning btn-sm" style="margin-top: -20%">KYC Pending</button>
                  @elseif(App\Kyc::where('user_id', Auth::user()->id)->first()->status == 3)
                      <button class="btn btn-success btn-sm" style="margin-top: -20%">KYC Verified</button>
                  @endif
                @endif
