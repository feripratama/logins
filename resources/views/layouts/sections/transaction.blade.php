            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <thead>
                        <tr>
                            <th>TxHash</center></th>
                            <th>Block Number</center></th>
                            <th>From</center></th>
                            <th>To</center></th>
                            <th>Value</center></th>
                            <th>Date Time</center></th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($datas as $data)
                        <tr>
                            <td><a href="https://rinkeby.etherscan.io/tx/{{$data->hash}}" target="_blank">{{substr($data->hash, 0, 10)}}</a></td>
                            <td>{{$data->blockNumber}}</td>
                            <td><a href="https://rinkeby.etherscan.io/address/{{$data->from}}" target="_blank">{{substr($data->from, 0, 10)}}</a></td>
                            <td><a href="https://rinkeby.etherscan.io/address/{{$data->from}}" target="_blank">{{substr($data->to, 0, 10)}}</a></td>
