                                        ...
                                        <div class="accordion-s2" id="accordion-1">
                                            <div class="card active">
                                                <div class="card-header">
                                                    ...
                                                    <a data-toggle="collapse" data-target="#collapse-1-1">
                                                        What is EastPac?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                    </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>
                                                        <a class="collapsed" data-toggle="collapse" data-target="#collapse-1-2">
                                                            What business model EastPac?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                        </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                                ...
                                                <div id="collapse-1-2" class="collapse" data-parent="#accordion-1">
                                                    <div class="card-body">
                                                        <p style="color:#fe4350"> EastPac is the only a blockchain ecosystem attended the DIGITAL STOCK concept that can be owned, as have the token East where you will get the benefit profit sharing (dividends) from all platforms that exist in the ecosystem EastPac.
                                                        </p>
                                                    </div>
                                                    <!-- end card-body -->
                                                </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>
                                                        <a class="collapsed" data-toggle="collapse" data-target="#collapse-1-3">
                                                            What services are offered EastPac?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                        </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                                ...
                                                <div id="collapse-1-3" class="collapse" data-parent="#accordion-1">
                                                    <div class="card-body">
                                                        <p style="color:#fe4350"> Eastpac presents a diverse range of platforms that are highly profitable, where in EastPac ecosystem you can perform transaction ranging from fashion to the fulfillment of the needs of your trip and everything there in EastPac ecosystem.</p>
                                                    </div>
                                                    <!-- end card-body -->
                                                </div>
                                                <!-- end collapse-1-3 -->
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>
                                                        <a class="collapsed" data-toggle="collapse" data-target="#collapse-1-4">
                                                            What are the advantages of EastPac?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                        </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                                ...
                                                <div id="collapse-1-4" class="collapse" data-parent="#accordion-1">
                                                    <div class="card-body">
                                                        <p style="color:#fe4350"> By joining in EastPac ecosystem and have the token EastPac you'll get the convenience, comfort, as well as discounts of up to 80% throughout the ecosystem EastPac.</p>
                                                    </div>
                                                    <!-- end card-body -->
                                                </div>
                                                <!-- end collapse-1-4 -->
                                        ...
                                        <div class="accordion-s2" id="accordion-2">
                                            <div class="card active">
                                                <div class="card-header">
                                                    <h5>
                                                        <a data-toggle="collapse" data-target="#collapse-2-1">
                                                            Whether EastPac have competitor? and How superior EastPac or prominent among other competitor?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                        </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                                ...
                                                <div id="collapse-2-1" class="collapse show" data-parent="#accordion-2">
                                                    <div class="card-body">
                                                        <p style="color:#fe4350"> Basically every business has a competitor, but give EastPac convenience, comfort, and the unique that is not owned by any other competitor, such a complete ecosystem and one account for all platforms.</p>
                                                    </div>
                                                    <!-- end card-body -->
                                                </div>
                                                <!-- end collapse-2-1 -->
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>
                                                        <a class="collapsed" data-toggle="collapse" data-target="#collapse-2-2">
                                                            How does EastPac?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                        </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                                ...
                                                <div id="collapse-2-2" class="collapse" data-parent="#accordion-2">
                                                    <div class="card-body">
                                                        <p style="color:#fe4350">The workings EastPac is you can merge into user EastPac and then milliki the token East which can be shared and can be used/traded throughout EastPac ecosystem.</p>
                                                    </div>
                                                    <!-- end card-body -->
                                                </div>
                                                <!-- end collapse-2-2 -->
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>
                                                        <a class="collapsed" data-toggle="collapse" data-target="#collapse-2-4">
                                                            When EastPac registered on Crypto?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                        </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                                ...
                                                <div id="collapse-2-4" class="collapse" data-parent="#accordion-2">
                                                    <div class="card-body">
                                                        <p style="color:#fe4350"> 15 days after IDSO ends.</p>
                                                    </div>
                                                    <!-- end card-body -->
                                                </div>
                                                <!-- end collapse-2-4 -->
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>
                                                        <a class="collapsed" data-toggle="collapse" data-target="#collapse-2-3">
                                                            When IDSO EastPac will end?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                        </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                                ...
                                                <div id="collapse-2-3" class="collapse" data-parent="#accordion-2">
                                                    <div class="card-body">
                                                        <p style="color:#fe4350"> April, 30 2019</p>
                                                    </div>
                                                    <!-- end card-body -->
                                                </div>
                                                <!-- end collapse-2-3 -->
                                        ...
                                        <div class="accordion-s2" id="accordion-3">
                                            <div class="card active">
                                                <div class="card-header">
                                                    <h5>
                                                        <a data-toggle="collapse" data-target="#collapse-3-1">
                                                            What is a token ?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                        </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                                ...
                                                <div id="collapse-3-1" class="collapse show" data-parent="#accordion-3">
                                                    <div class="card-body">
                                                        <p style="color:#fe4350">A token, similar to a cryptocurrency, is a digital asset that can be stored, spent, freely transferred to other people. It is powered by Ethereum blockchain and serves as a foundation for decentralization of a digital project’s economy.</p>
                                                    </div>
                                                    <!-- end card-body -->
                                                </div>
                                                <!-- end collapse-3-1 -->
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>
                                                        <a class="collapsed" data-toggle="collapse" data-target="#collapse-3-2">
                                                            What is EST Token ?<span class="plus-minus"><span class="ti ti-angle-up"></span></span>
                                                        </a>
                                                    </h5>
                                                </div>
                                                <!-- end card-header -->
                                                ...
                                                <div id="collapse-3-2" class="collapse" data-parent="#accordion-3">
                                                    <div class="card-body">
                                                        <p style="color:#fe4350">EST token is the token eastpac project utility, you can use the transaction token to the east, the fulfillment of the requirement. When you have a easttoken you will also benefit from the east of 80% token.</p>
                                                    </div>
                                                    <!-- end card-body -->
                                                </div>
                                                <!-- end collapse-3-2 -->
